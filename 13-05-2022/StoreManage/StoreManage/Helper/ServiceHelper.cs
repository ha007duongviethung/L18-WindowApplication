...
using StoreManage.Service;

namespace StoreManage.Helper
{
    public sealed class ServiceHelper
    {
        static public void ConfigureServices()
        {
             ...
             */
            string libraryName = "StoreManage";
            string viewModelNameSpace = libraryName + ".ViewModels";
            string projectName = "StoreManage";
            string viewNameSpace = projectName + ".Views";
            string viewDialogNameSpace = projectName + ".Views.Dialogs";
