...
{
    public sealed partial class EditingDialog : ContentDialog
    {
        public EditingDialog()
        {
            ...
            EditProductDialog.PrimaryButtonStyle = buttonPrimaryStyle;
            EditProductDialog.SecondaryButtonStyle = buttonSecondaryStyle;
        }
    }
}
